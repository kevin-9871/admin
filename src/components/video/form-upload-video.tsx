      ...
      >
        ...
        <Fragment>
          <div key="thumbnail" className="ant-row ant-form-item">
            ...
            <div className="ant-col ant-col-16 ant-form-item-control">
              ...
              <div className="ant-form-item-explain">
                <div>
                  Image must smaller than {env.maximumSizeUploadImage || 2}
                  MB! Only accept {env.imageAccept}.
                </div>
              </div>
            </div>
          </div>
          <div key="video" className="ant-row ant-form-item">
            ...
            <div className="ant-col ant-col-16 ant-form-item-control">
              <Upload
                accept={env.videoAccept || 'video/*,.mkv'}
                multiple={false}
                showUploadList={false}
                disabled={uploading || haveVideo}
              ...
              <div className="ant-form-item-explain">
                <div>
                  Video must smaller than {env.maximumSizeUploadVideo || 20}
                  MB! Only accept {env.videoAccept}.
                </div>
              </div>
            </div>
          </div>
