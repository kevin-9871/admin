...
export class FormUploadBanner extends PureComponent<IProps> {
  ...
  beforeUpload(file) {
    ...
    const isMaxSize =
      file.size / 1024 / 1024 < (env.maximumSizeUploadImage || 10);
    if (!isMaxSize) {
      message.error(
        `Image must be smaller than ${env.maximumSizeUploadImage || 10}MB!`
      );
      return false;
    }
            ...
            <div key="thumbnail" className="ant-row ant-form-item">
              ...
              <div className="ant-col ant-col-16 ant-form-item-control">
                ...
                <div className="ant-form-item-explain">
                  <div>
                    Image must smaller than {env.maximumSizeUploadImage || 10} MB!
                </div>
                </div>
              </div>
            </div>)}
